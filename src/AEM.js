...
const defaultConfig = {
    ACTIVATION_TREE_API_ENDPOINT: ACTIVATION_TREE_API_ENDPOINT,
    CRX_API_ENDPOINT: CRX_API_ENDPOINT,
    CRX_REFERER: CRX_REFERER,
    REPLICATION_API_ENDPOINT: REPLICATION_API_ENDPOINT,
    TOKEN_API_ENDPOINT: TOKEN_API_ENDPOINT,
    PAGE_VERSION_ENDPOINT: PAGE_VERSION_ENDPOINT,
 ...
 * @class
 */
function AEM(host, port, username, password, config) {
    /**
     ...
     */
    this.createNode = function (path, type, props) {
        var that = this;
    ...
    this.getNode = function (path) {
        ...
        return new Promise(function (res, rej) {
            that.getRequest(path)
                .then(function (resp) {
                    return resp.json();
                })
                .then(function (config) {
                    return res(new Node(this, path, config))
                })
                .catch(rej);
        })
    };
